#### this script comes from https://github.com/Xilinx/XilinxBoardStore
...
def createXitemJson(xmldoc, output_file) :
...
def main():
    ...
    try : 
        ...
        createXitemJson(xmldoc, args.output_file)
